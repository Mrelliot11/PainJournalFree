...
import com.dubrow.paintrackerfree.databinding.ItemDateHeaderBinding
import com.dubrow.paintrackerfree.databinding.ItemPainEntryBinding
...
class HistoryAdapter(
    ...
    inner class EntryVH(private val b: ItemPainEntryBinding) : RecyclerView.ViewHolder(b.root) {
        ...
        private fun painLevelColor(level: Int) = when {
            level <= 3 -> com.dubrow.paintrackerfree.R.drawable.bg_pain_low
            level <= 6 -> com.dubrow.paintrackerfree.R.drawable.bg_pain_mid
            else -> com.dubrow.paintrackerfree.R.drawable.bg_pain_high
        }
    }
}
